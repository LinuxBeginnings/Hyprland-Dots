...
bind("SUPER", "j", exec_cmd("hyprctl dispatch cyclenext"))
bind("SUPER", "k", exec_cmd("hyprctl dispatch cyclenext prev"))
...
bind("ALT", "Tab", exec_cmd("hyprctl dispatch cyclenext; hyprctl dispatch bringactivetotop"))
